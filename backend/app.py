...
from routes.management_routes import api_management_post, api_management_get, api_management_patch, api_management_delete
...
api.include_router(api_management_delete)
